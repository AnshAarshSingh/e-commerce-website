        ...
        <!-- Jumbotron Header -->
            <div class="jumbotron home-spacer" id="products-jumbotron">
                <center>
                    ...
                    <p>We have handpicked the best smartphones from biggest flagships for you. No need to hunt around, we have it all in one place.</p>
              </center>
            </div>
            <hr>
            <br>
        ...
        <div class="row">
            <div class="col-sm-3" >
               ...
               <br>
                <div class="panel panel-default">
                    <div class="panel-heading  color">
                        <h4 style="color:#ffb441">Operating System</h4>
                    </div>
            ...
            <div class="col-sm-9 text-center">
                <div class="panel-group">
                  <!----------------------------------------------------featured phone----------------------------------->
                   <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 style="color:#ffb441">Featured Mobile</h3>
                        </div>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="ios" style="color:#ffb441">apple</h3>
                        </div>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="samsung" style="color:#ffb441">samsung</h3>
                        </div>
                ...
                <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="oneplus" style="color:#ffb441">oneplus</h3>
                        </div>
                   ...
                   <div class="panel panel-default">
                        <div class="panel-heading  color">
                            <h3 id="xiaomi" style="color:#ffb441">xiaomi</h3>
                        </div>
