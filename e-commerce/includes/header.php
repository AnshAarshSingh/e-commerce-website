   ...
   <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><span style="color:#ffb441; font-size: 23px; font-family: Matura MT Script Capitals;" >e-Store.com</span></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar" >
            <ul class="nav navbar-nav navbar-right">
                ...
                if (isset($_SESSION['email'])) 
                {
                    ...
                    <li><a href = "settings.php"><span class = "glyphicon glyphicon-lock"></span> Security</a></li>
